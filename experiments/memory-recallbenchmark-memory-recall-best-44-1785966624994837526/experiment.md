...
experiment_id: memory-recallbenchmark-memory-recall-best-44-1785966624994837526
status: planned
time_budget_minutes: 30

## Goal

提升能力 memory_recall（benchmark memory-recall）的分数：当前 best 4/4

## Success Criteria

benchmark memory-recall 的 scoreboard best 总分严格超过 4/4（Penguin：无严格提升不视为成功）
