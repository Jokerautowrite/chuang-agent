...
fn runtime_event_serializes_supported_m1_event_types() {
    let cases = [
        ...
        (RuntimeEventKind::ContextPacked, "context_packed"),
        (RuntimeEventKind::ProviderRequested, "provider_requested"),
        (RuntimeEventKind::ProviderResponded, "provider_responded"),
        (RuntimeEventKind::RiskClassified, "risk_classified"),
        (RuntimeEventKind::MemoryProposed, "memory_proposed"),
        (RuntimeEventKind::MemoryCommitted, "memory_committed"),
        (RuntimeEventKind::SkillProposed, "skill_proposed"),
        (RuntimeEventKind::SkillSolidified, "skill_solidified"),
