...
assert(receipt.replyText.includes("approval_scope"));
assert(receipt.replyText.includes("rollback_condition"));
assert(receipt.replyText.includes("acceptance_status"));
assert(receipt.replyText.includes("can_mark_real_live_ready"));
assert(receipt.replyText.includes("cannot_mark_complete_without_operator_evidence"));
assert(receipt.replyText.includes("runtime_report_id"));
assert(receipt.replyText.includes("service_receipts"));
assert(receipt.replyText.includes("subagent_live_rehearsal"));
assert(receipt.replyText.includes("readonly_boundaries"));
assert(receipt.replyText.includes("service_evidence"));
assert(receipt.replyText.includes("real_live_acceptance"));
assert(receipt.replyText.includes("CHUANG_LIVE_OPERATOR"));
assert(receipt.replyText.includes("CHUANG_LIVE_OPERATOR_ENV_FILE"));
...
assert.strictEqual(liveReceipt.replyText, receipt.replyText);
