...
print("candidate_live_readiness_state=" + str(live_readiness["overall_state"]))
print("candidate_live_readiness_real_external_acceptance_pending=" + str(live_readiness["real_external_acceptance_pending"]).lower())
print("candidate_live_readiness_ready_does_not_mean_live=" + str(live_readiness["ready_does_not_mean_live"]).lower())
...
print("candidate_project_goal_run_last_checkpoint_created_at=" + str(project_goal_run["last_checkpoint_created_at"]))
