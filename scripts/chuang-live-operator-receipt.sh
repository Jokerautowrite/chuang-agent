...
SERVICE_RECEIPTS = [
    ...
    },
    {
        ...
        "evidence": {
            ...
            "bounded_live_call_receipt_ref": "<fill_after_test>",
            "runtime_report_id": "<fill_after_test>",
        },
        "required": [
    ...
    },
    {
        ...
        "required": [
            "single worker only",
            "bounded command and allowlist are explicit",
            "live gate and governance evidence are recorded",
            "report admission accepted or blocked with structured reason",
        ],
    },
    {
        "id": "desktop",
