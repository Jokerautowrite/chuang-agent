...
assert data["service_receipts"][1]["evidence"]["does_not_call_provider"] is True
assert data["service_receipts"][1]["evidence"]["does_not_read_provider_readiness"] is True
...
print("project_goal_run_checkpoint_log_complete=" + str(project_goal_run["checkpoint_log_complete"]).lower())
print("project_goal_run_last_checkpoint=" + str(project_goal_run["last_checkpoint_id"]))
print("project_goal_run_last_checkpoint_created_at=" + str(project_goal_run["last_checkpoint_created_at"]))
print("project_goal_run_last_completed_worker_count=" + str(len(project_goal_run["last_completed_worker_ids"])))
print("project_goal_run_last_validation_note_count=" + str(len(project_goal_run["last_validation_notes"])))
